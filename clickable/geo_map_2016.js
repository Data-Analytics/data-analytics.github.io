...
d3.csv("candidate_list_2016.csv", function(data_csv) {
  
  data_set = data_csv.filter(function(d){ return (d.Alliance==getParameterByName('front')+'+') }) 
  
  
  console.log(data_set,getParameterByName('front')+'+');
