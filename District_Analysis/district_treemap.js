...
function onRender() {   
    ...
    var treemap = d3.layout.treemap()
        ...
        .size([width, height])
        .sticky(true)
        .value(function(d) {return d[group_by];})
        .children(function(d) {return d.values;});
    
    
    d3.csv("district.csv", function(data_csv) {
  ...
  var cell = svg.data([data_root]).selectAll("g")
      .data(treemap.nodes)
    .enter().append("a")
      .attr("xlink:href",function(d) { return 'https://www.google.co.in/search?q='+d.Headquarters} )
      .attr("target","_blank").append("rect")
      .attr("x", function(d) { return d.x; })
      .attr("y", function(d) { return d.y; })
      .attr("width", function(d) { return d.dx; })
      .attr("height", function(d) { return d.dy; })
      .attr("data-title",function(d) { return '<p>District : '+d.District+'</p> <br/> <p>Head quarters : '+d.Headquarters+'</p> <br/> <p>State : '+d.State+'</p> <br/><p> '+group_by+' : '+d[group_by]+'</p>' ;})
      .attr("sub_link",function(d) { return d.District+d.State+d.Headquarters ;})
