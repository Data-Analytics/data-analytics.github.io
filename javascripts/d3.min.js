(function() {
    ...
    function dD() {
        dw && ds === d3.event.target && (d3.event.stopPropagation(), d3.event.preventDefault(), dw = !1, ds = null)
    }

    function dC() {
        dl && (dv && ds === d3.event.target && (dw = !0), dB(), dl = null)
    }

    function dB() {
        dm = null, dl && (dv = !0, dE(dq[2], d3.svg.mouse(dt), dl))
    }

    function dA() {
        var a = d3.svg.touches(dt);
        switch (a.length) {
            case 1:
                var b = a[0];
                dE(dq[2], b, dn[b.identifier]);
                break;
            case 2:
                var c = a[0],
                    d = a[1],
                ...
                dE(Math.log(d3.event.scale) / Math.LN2 + f[2], e, h)
        }
    }
    ...
    function dz() {
        var a = d3.svg.touches(dt),
            ...
            c = a.length,
            d;
        while (++b < c) dn[(d = a[b]).identifier] = dx(d);
        return a
    }

    function dy() {
        dk || (dk = d3.select("body").append("div").style("visibility", "hidden").style("top", 0).style("height", 0).style("width", 0).style("overflow-y", "scroll").append("div").style("height", "2000px").node().parentNode);
        var a = d3.event,
            b;
        try {
            dk.scrollTop = 1e3, dk.dispatchEvent(a), b = 1e3 - dk.scrollTop
        } catch (c) {
    ...
    function di() {
        dd && c$ === d3.event.target && (dj(), dd = !1, c$ = null)
    }

    function dh() {
        !c_ || (de("dragend"), c_ = null, dc && c$ === d3.event.target && (dd = !0, dj()))
    }
    ...
    function cQ(a, b) {
        ...
        if (cP < 0 && (window.scrollX || window.scrollY)) {
            var d = d3.select(document.body).append("svg:svg").style("position", "absolute").style("top", 0).style("left", 0),
                e = d[0][0].getScreenCTM();
            cP = !e.f && !e.e, d.remove()
        }
        cP ? (c.x = b.pageX, c.y = b.pageY) : (c.x = b.clientX, c.y = b.clientY), c = c.matrixTransform(a.getScreenCTM().inverse());
        return [c.x, c.y]
    }
    ...
    function cF(a) {
        function j(f) {
            ...
            var j = cf(this, f, b, d),
                k = cf(this, f, b === c ? cG(j) : c, d === e ? cH(j) : e);
    ...
    function cE(a) {
        var b, c = -1,
            d = a.length,
            e, f;
        while (++c < d) b = a[c], e = b[0], f = b[1] + b$, b[0] = e * Math.cos(f), b[1] = e * Math.sin(f);
        return a
    }

    function cD(a) {
        return a.length < 3 ? cj(a) : a[0] + cp(a, cC(a))
    }
    ...
    function cC(a) {
        var b = [],
            ...
            h = -1,
            i = a.length - 1;
        while (++h < i) c = cA(a[h], a[h + 1]), Math.abs(c) < 1e-6 ? g[h] = g[h + 1] = 0 : (d = g[h] / c, e = g[h + 1] / c, f = d * d + e * e, f > 9 && (f = c * 3 / Math.sqrt(f), g[h] = f * d, g[h + 1] = f * e));
        h = -1;
    ...
    function cB(a) {
        var b = 0,
            ...
            f = a[1],
            g = d[0] = cA(e, f);
        while (++b < c) d[b] = g + (g = cA(e = f, f = a[b + 1]));
        d[b] = g;
        return d
    }
    ...
    function ce(a) {
        function g(d) {
            return d.length < 1 ? null : "M" + e(a(cf(this, d, b, c)), f)
        }
        var b = cg,
            c = ch,
            d = "linear",
    ...
    function bT(a, b) {
        ...
        f.domain = function(d) {
            ...
            var h = c[0],
                i = c[1],
                j = (i - h) / (a.length - 1 + g);
            d = a.length < 2 ? [(h + i) / 2] : d3.range(h + j * g / 2, i + j / 2, j), e = 0, b = {
                t: "rangePoints",
                x: c,
                p: g
            };
            ...
            var h = c[0],
                i = c[1],
                j = (i - h) / (a.length + g);
            d = d3.range(h + j * g, i, j), e = j * (1 - g), b = {
                t: "rangeBands",
                x: c,
                p: g
            };
            ...
            var h = c[0],
                ...
                k = i - h - (a.length - g) * j;
            d = d3.range(h + Math.round(k / 2), i, j), e = Math.round(j * (1 - g)), b = {
                t: "rangeRoundBands",
                x: c,
                p: g
            };
    ...
    function bR(a, b) {
        ...
        e.invert = function(b) {
            ...
            return bJ(e.domain(), a)
        }, e.tickFormat = function(a) {
            return bK(e.domain(), a)
        }, e.nice = function() {
            return e.domain(bD(e.domain(), bH))
    ...
    function bN(a, b) {
        ...
        d.invert = function(b) {
            ...
            b = e[0] < 0 ? bQ : bP, c = b.pow, a.domain(e.map(b));
            return d
        }, d.nice = function() {
            a.domain(bD(a.domain(), bE));
            return d
        }, d.ticks = function() {
            var d = bC(a.domain()),
                e = [];
            ...
            arguments.length < 2 && (e = bO);
            if (arguments.length < 1) return e;
            var f = a / d.ticks().length,
                g = b === bQ ? (h = -1e-15, Math.floor) : (h = 1e-15, Math.ceil),
                h;
            return function(a) {
    ...
    function bK(a, b) {
        return d3.format(",." + Math.max(0, -Math.floor(Math.log(bI(a, b)[2]) / Math.LN10 + .01)) + "f")
    }

    function bJ(a, b) {
        return d3.range.apply(d3, bI(a, b))
    }
    ...
    function bz() {
        var a = null,
            b = bv,
            c = Infinity;
        while (b) b.flush ? b = a ? a.next = b.next : bv = b.next : (c = Math.min(c, b.then + b.delay), b = (a = b).next);
        return c
    }
    ...
    function by() {
        ...
        var d = bz() - b;
        d > 24 ? (isFinite(d) && (clearTimeout(bx), bx = setTimeout(by, d)), bw = 0) : (bw = 1, bA(by))
    }
    ...
    function bp(a) {
        ...
        function b(b, c, d) {
            ...
            return e == null ? d != "" && bn : d != e && d3.interpolate(d, e)
        }
        return typeof a == "function" ? b : a == null ? bo : (a += "", c)
    }
    ...
    function bm(a, b, c) {
        ...
        var d = {},
            ...
            f = bt;
        a.id = b, a.time = c, a.tween = function(b, c) {
            if (arguments.length < 2) return d[b];
            c == null ? delete d[b] : d[b] = c;
            return a
        }, a.ease = function(b) {
            if (!arguments.length) return f;
            f = typeof b == "function" ? b : d3.ease.apply(d3, arguments);
            return a
        }, a.each = function(b, c) {
            if (arguments.length < 2) return bu.call(a, b);
            e[b].add(c);
            return a
        }, d3.timer(function(g) {
            a.each(function(h, i, j) {
                function r() {
                    --o.count || delete l.__transition__;
                    return 1
                }
                ...
                function q(a) {
                    ...
                    if (c >= 1) {
                        r(), bs = b, e.end.dispatch.call(l, h, i), bs = 0;
                        return 1
                    }
                }
                ...
                function p(a) {
                    ...
                    e.start.dispatch.call(l, h, i), q(a) || d3.timer(q, 0, c);
                    return 1
                }
                var k = [],
                    l = this,
    ...
    function bg(a, b) {
        ...
        if (arguments.length < 2) {
            ...
            var e = d.className;
            c.lastIndex = 0;
            return c.test(e.baseVal != null ? e.baseVal : e)
        }
    ...
    function $(a, b, c) {
        ...
        function f(a) {
            ...
            return a < 60 ? d + (e - d) * a / 60 : a < 180 ? e : a < 240 ? d + (e - d) * (240 - a) / 60 : d
        }
        var d, e;
        a = a % 360, a < 0 && (a += 360), b = b < 0 ? 0 : b > 1 ? 1 : b, c = c < 0 ? 0 : c > 1 ? 1 : c, e = c <= .5 ? c * (1 + b) : c + b - c * b, d = 2 * c - e;
        return Q(g(a + 120), g(a), g(a - 120))
    }
    ...
    function T(a, b, c) {
        ...
        if (g) {
            ...
            switch (g[1]) {
                ...
                case "rgb":
                    return b(V(h[0]), V(h[1]), V(h[2]))
            }
        }
        if (i = W[a]) return b(i.r, i.g, i.b);
    ...
    function N(a) {
        return a in M || /\bcolor\b/.test(a) ? d3.interpolateRgb : d3.interpolate
    }
    ...
    d3.functor = function(a) {
        ...
        arguments.length > 1 && (a = a.map(b)), a = a.filter(j);
        ...
        for (var a = -1, b = d3.min(arguments, k), c = Array(b); ++a < b;)
            for (var d = -1, e, f = c[a] = Array(e); ++d < e;) f[d] = arguments[d][a];
        return c
    ...
    d3.round = function(a, b) {
        ...
        var b = {},
            c;
        for (var d = 0, e = arguments.length; d < e; d++) c = arguments[d], b[c] = o(c);
        return b
        ...
        return function(a) {
            ...
            if (e) {
                ...
                n < f && (a = Array(f - n + 1).join(c) + a), g && (a = t(a)), a = b + a
            } else {
                g && (a = t(a)), a = b + a;
                var n = a.length;
                n < f && (a = Array(f - n + 1).join(c) + a)
            }
            return a + k
        }
    };
    var p = /(?:([^{])?([<>=^]))?([+\- ])?(#)?(0)?([0-9]+)?(,)?(\.[0-9]+)?([a-zA-Z%])?/,
        q = {
            g: function(a, b) {
        ...
        u = ["y", "z", "a", "f", "p", "n", "μ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(v);
    d3.formatPrefix = function(a, b) {
        var c = 0;
        a && (a < 0 && (a *= -1), b && (a = d3.round(a, r(a, b))), c = 1 + Math.floor(1e-12 + Math.log(a) / Math.LN10), c = Math.max(-24, Math.min(24, Math.floor((c <= 0 ? c + 1 : c - 1) / 3) * 3)));
        return u[8 + c / 3]
    };
    var w = E(2),
        x = E(3),
    ...
    d3.ease = function(a) {
        ...
        return A(z[d](y[c].apply(null, Array.prototype.slice.call(arguments, 1))))
        ...
        var c, d, e, f = 0,
            ...
            j, k;
        L.lastIndex = 0;
        for (d = 0; c = L.exec(b); ++d) c.index && h.push(b.substring(f, g = c.index)), i.push({
            i: h.length,
            x: c[0]
        }), h.push(null), f = L.lastIndex;
        ...
        var c = a.r,
            ...
            h = b.b - e;
        return function(a) {
            return "#" + S(Math.round(c + f * a)) + S(Math.round(d + g * a)) + S(Math.round(e + h * a))
        }
        ...
        var c = a.h,
            ...
            h = b.l - e;
        return function(a) {
            return $(c + f * a, d + g * a, e + h * a).toString()
        }
        ...
        var c = {},
            d = {},
            e;
        for (e in a) e in b ? c[e] = N(e)(a[e], b[e]) : d[e] = a[e];
    ...
    d3.interpolators = [d3.interpolateObject, function(a, b) {
        ...
        return (typeof b == "string" ? b in W || /^(#|rgb\(|hsl\()/.test(b) : b instanceof R || b instanceof Z) && d3.interpolateRgb(String(a), b)
    }, function(a, b) {
        return typeof b == "number" && d3.interpolateNumber(+a, b)
    }], d3.rgb = function(a, b, c) {
        return arguments.length === 1 ? a instanceof R ? Q(a.r, a.g, a.b) : T("" + a, Q, $) : Q(~~a, ~~b, ~~c)
        ...
        var b = this.r,
            ...
            d = this.b,
            e = 30;
        if (!b && !c && !d) return Q(e, e, e);
        b && b < e && (b = e), c && c < e && (c = e), d && d < e && (d = e);
        return Q(Math.min(255, Math.floor(b / a)), Math.min(255, Math.floor(c / a)), Math.min(255, Math.floor(d / a)))
    ...
    for (var X in W) W[X] = T(W[X], Q, $);
    d3.hsl = function(a, b, c) {
        return arguments.length === 1 ? a instanceof Z ? Y(a.h, a.s, a.l) : T("" + a, U, Y) : Y(+a, +b, +c)
    }, Z.prototype.brighter = function(a) {
        a = Math.pow(.7, arguments.length ? a : 1);
        return Y(this.h, this.s, this.l / a)
    }, Z.prototype.darker = function(a) {
        a = Math.pow(.7, arguments.length ? a : 1);
        return Y(this.h, this.s, a *
            this.l)
    ...
    typeof Sizzle == "function" && (ba = function(a, b) {
        return Sizzle(a, b)[0]
    }, bb = function(a, b) {
    ...
    d3.selection = function() {
        return bl
    }, d3.selection.prototype = bc, bc.select = function(a) {
        var b = [],
            c, d, e, f;
        typeof a != "function" && (a = bd(a));
    ...
    }, bc.classed = function(a, b) {
        var c = a.split(bf),
            d = c.length,
            e = -1;
        if (arguments.length > 1) {
            while (++e < d) bg.call(this, c[e], b);
            return this
        }
        while (++e < d)
            if (!bg.call(this, c[e])) return !1;
        return !0
    };
    var bf = /\s+/g;
    bc.style = function(a, b, c) {
        function f() {
        ...
        return arguments.length < 2 ? window.getComputedStyle(this.node(), null).getPropertyValue(a) : this.each(b == null ? d : typeof b == "function" ? f : e)
    }, bc.property = function(a, b) {
        function e() {
            var c = b.apply(this, arguments);
    ...
    }, bc.insert = function(a, b) {
        function d() {
            return this.insertBefore(document.createElementNS(a.space, a.local), ba(b, this))
        }

        function c() {
            return this.insertBefore(document.createElement(a), ba(b, this))
        }
        a = d3.ns.qualify(a);
        ...
        function f(a, f) {
            ...
            if (b) {
                ...
                for (g = -1; ++g < i;) o = q[s = b.call(f, p = f[g], g)], o ? (o.__data__ = p, l[g] = o, m[g] = n[g] = null) : (m[g] = bh(p), l[g] = n[g] = null), delete q[s];
                for (g = -1; ++g < h;) r[g] in q && (n[g] = a[g])
            } else {
                for (g = -1; ++g < j;) o = a[g], p = f[g], o ? (o.__data__ = p, l[g] = o, m[g] = n[g] = null) : (m[g] = bh(p), l[g] = n[g] = null);
                for (; g < i; ++g) m[g] = bh(f[g]), l[g] = n[g] = null;
    ...
    var bj = [];
    bj.append = bc.append, bj.insert = bc.insert, bj.empty = bc.empty, bj.select = function(a) {
        var b = [],
            c, d, e, f, g;
        ...
        return this
    }, bc.on = function(a, b, c) {
        arguments.length < 3 && (c = !1);
        var d = "__on" + a,
            e = a.indexOf(".");
        e > 0 && (a = a.substring(0, e));
        return arguments.length < 2 ? (e = this.node()[d]) && e._ : this.each(function(e, f) {
            function h(a) {
                var c = d3.event;
                d3.event = a;
                try {
        ...
        return bm(a, bs || ++br, Date.now())
    };
    var bl = _([
        [document]
    ]);
    bl[0].parentNode = document.documentElement, d3.select = function(a) {
        return typeof a == "string" ? bl.select(a) : _([
            [a]
        ])
    }, d3.selectAll = function(a) {
        return typeof a == "string" ? bl.selectAll(a) : _([d(a)])
    };
    var bn = {},
        bq = [],
        br = 0,
        bs = 0,
        bt = d3.ease("cubic-in-out");
    bq.call = bc.call, d3.transition = function() {
        return bl.transition()
    }, d3.transition.prototype = bq, bq.select = function(a) {
        var b = [],
            c, d, e;
        typeof a != "function" && (a = bd(a));
        for (var f = -1, g = this.length; ++f < g;) {
        ...
        return bm(b, this.id, this.time).ease(this.ease())
    }, bq.selectAll = function(a) {
        var b = [],
            c, d, e;
        typeof a != "function" && (a = be(a));
        for (var f = -1, g = this.length; ++f < g;)
        ...
        return bm(b, this.id, this.time).ease(this.ease())
    }, bq.attr = function(a, b) {
        return this.attrTween(a, bp(b))
    }, bq.attrTween = function(a, b) {
        function e(a, d) {
            var e = b.call(this, a, d, this.getAttributeNS(c.space, c.local));
            return e === bn ? (this.removeAttributeNS(c.space, c.local), null) : e && function(a) {
    ...
    d3.timer = function(a, b, c) {
        ...
        d || (bv = {
            ...
            delay: b,
            next: bv
        }), bw || (bx = clearTimeout(bx), bw = 1, bA(by))
    ...
    d3.scale = {}, d3.scale.linear = function() {
        return bF([0, 1], [0, 1], d3.interpolate, !1)
    }, d3.scale.log = function() {
        return bN(d3.scale.linear(), bP)
    };
    var bO = d3.format("e");
    bP.pow = function(a) {
        ...
        return d3.scale.ordinal().range(bU)
    }, d3.scale.category20 = function() {
        return d3.scale.ordinal().range(bV)
    }, d3.scale.category20b = function() {
        return d3.scale.ordinal().range(bW)
    }, d3.scale.category20c = function() {
        return d3.scale.ordinal().range(bX)
    };
    var bU = ["#1f77b4", "#ff7f0e", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf"],
        bV = ["#1f77b4", "#aec7e8", "#ff7f0e", "#ffbb78", "#2ca02c", "#98df8a", "#d62728", "#ff9896", "#9467bd", "#c5b0d5", "#8c564b", "#c49c94", "#e377c2", "#f7b6d2", "#7f7f7f", "#c7c7c7", "#bcbd22", "#dbdb8d", "#17becf", "#9edae5"],
        bW = ["#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6"],
        bX = ["#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9"];
    d3.scale.quantile = function() {
        ...
        function e() {
            var e = a.apply(this, arguments),
                ...
                g = c.apply(this, arguments) + b$,
                h = d.apply(this, arguments) + b$,
                ...
                m = Math.cos(h),
                n = Math.sin(h);
            return i >= b_ ? e ? "M0," + f + "A" + f + "," + f + " 0 1,1 0," + -f + "A" + f + "," + f + " 0 1,1 0," + f + "M0," + e + "A" + e + "," + e + " 0 1,0 0," + -e + "A" + e + "," + e + " 0 1,0 0," + e + "Z" : "M0," + f + "A" + f + "," + f + " 0 1,1 0," + -f + "A" + f + "," + f + " 0 1,1 0," + f + "Z" : e ? "M" + f * k + "," + f * l + "A" + f + "," + f + " 0 " + j + ",1 " + f * m + "," + f * n + "L" + e * m + "," + e * n + "A" + e + "," + e + " 0 " + j + ",0 " + e * k + "," + e * l + "Z" : "M" + f * k + "," + f * l + "A" + f + "," + f + " 0 " + j + ",1 " + f * m + "," + f * n + "L0,0" + "Z"
        }
        var a = ca,
            b = cb,
            c = cc,
        ...
        e.innerRadius = function(b) {
            ...
            var e = (a.apply(this, arguments) + b.apply(this, arguments)) / 2,
                f = (c.apply(this, arguments) + d.apply(this, arguments)) / 2 + b$;
    ...
    d3.svg.line.radial = function() {
        ...
        a.projection = function(a) {
            return arguments.length ? c(cO(b = a)) : b
        };
        return a
    }, d3.svg.mouse = function(a) {
        return cQ(a, d3.event)
    };
    var cP = /WebKit/.test(navigator.userAgent) ? -1 : 0;
    d3.svg.touches = function(a) {
        var b = d3.event.touches;
        return b ? d(b).map(function(b) {
            var c = cQ(a, b);
        ...
        function c(c, d) {
            return (cT[a.call(this, c, d)] || cT.circle)(b.call(this, c, d))
        }
        var a = cS,
            b = cR;
        c.type = function(b) {
    ...
    d3.svg.symbolTypes = d3.keys(cT);
    var cU = Math.sqrt(3),
        cV = Math.tan(30 * Math.PI / 180);
    d3.svg.axis = function() {
            ...
            j.each(function(k, l, m) {
                var n = d3.select(this),
                    o = j.delay ? function(a) {
                        ...
                        try {
                            bs = j.id;
                            return a.transition().delay(j[m][l].delay).duration(j[m][l].duration).ease(j.ease())
                        } finally {
                            bs = b
                        }
                    } : Object,
                ...
                switch (b) {
                    case "bottom":
                        A = cW, v.attr("x2", 0).attr("y2", d), z.select("line").attr("x2", 0).attr("y2", c), z.select("text").attr("x", 0).attr("y", Math.max(c, 0) + f).attr("dy", ".71em").attr("text-anchor", "middle"), E.attr("d", "M" + B[0] + "," + e + "V0H" + B[1] + "V" + e);
                        break;
                    case "top":
                        A = cW, v.attr("x2", 0).attr("y2", -d), z.select("line").attr("x2", 0).attr("y2", -c), z.select("text").attr("x", 0).attr("y", -(Math.max(c, 0) + f)).attr("dy", "0em").attr("text-anchor", "middle"), E.attr("d", "M" + B[0] + "," + -e + "V0H" + B[1] + "V" + -e);
                        break;
                    case "left":
                        A = cX, v.attr("x2", -d).attr("y2", 0), z.select("line").attr("x2", -c).attr("y2", 0), z.select("text").attr("x", -(Math.max(c, 0) + f)).attr("y", 0).attr("dy", ".32em").attr("text-anchor", "end"), E.attr("d", "M" + -e + "," + B[0] + "H0V" + B[1] + "H" + -e);
                        break;
                    case "right":
                        A = cX, v.attr("x2", d).attr("y2", 0), z.select("line").attr("x2", c).attr("y2", 0), z.select("text").attr("x", Math.max(c, 0) + f).attr("y", 0).attr("dy", ".32em").attr("text-anchor", "start"), E.attr("d", "M" + e + "," + B[0] + "H0V" + B[1] + "H" + e)
                }
        ...
        j.scale = function(b) {
            ...
            c = +a, d = g > 1 ? +b : c, e = g > 0 ? +arguments[g] : c;
            return j
        ...
        function c() {
            cZ = a, c$ = d3.event.target, db = df((c_ = this).parentNode), dc = 0, da = arguments
        }
    ...
    var cZ, c$, c_, da, db, dc, dd;
    d3.behavior.zoom = function() {
        function h() {
            d.apply(this, arguments);
            var b = dz(),
                c, e = Date.now();
            b.length === 1 && e - dp < 300 && dE(1 + Math.floor(a[2]), c = b[0], dn[c.identifier]), dp = e
        }

        function g() {
            d.apply(this, arguments);
            var b = d3.svg.mouse(dt);
            dE(d3.event.shiftKey ? Math.ceil(a[2] - 1) : Math.floor(a[2] + 1), b, dx(b))
        }

        function f() {
            d.apply(this, arguments), dm || (dm = dx(d3.svg.mouse(dt))), dE(dy() + a[2], d3.svg.mouse(dt), dm)
        }

        function e() {
            d.apply(this, arguments), dl = dx(d3.svg.mouse(dt)), dv = !1, d3.event.preventDefault(), window.focus()
        }

        function d() {
            dq = a, dr = b.zoom.dispatch, ds = d3.event.target, dt = this, du = arguments
        }

        function c() {
            this.on("mousedown.zoom", e).on("mousewheel.zoom", f).on("DOMMouseScroll.zoom", f).on("dblclick.zoom", g).on("touchstart.zoom", h), d3.select(window).on("mousemove.zoom", dB).on("mouseup.zoom", dC).on("touchmove.zoom", dA).on("touchend.zoom", dz).on("click.zoom", dD, !0)
        }
        var a = [0, 0, 0],
            b = d3.dispatch("zoom");
        c.on = function(a, d) {
