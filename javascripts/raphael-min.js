...
(function () {
    ...
    if (R.svg) {
        ...
        var theCircle = function (svg, x, y, r, w) {
            var el = $("circle");
            svg.canvas && svg.canvas[appendChild](el);
            var res = new Element(el, svg);
            res.attrs = {cx: x, cy: y, r: r, fill: "none", stroke: "#000" , wicket: w};
            res.type = "circle";
            $(el, res.attrs);
            return res;
        },
    ...
    paperproto.circle = function (x, y, r, w) {
        return theCircle(this, x || 0, y || 0, r || 0, w);
    };
